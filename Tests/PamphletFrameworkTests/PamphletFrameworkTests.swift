...
final class PamphletTests: XCTestCase {
    ...
    func testProcess() {
        ...
        PamphletFramework().process(prefix: nil,
                                    extensions: extensions,
                                    inDirectory: "/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test",
    ...
    func testPreprocessFollow1() {
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/includeFollow1.css")
    ...
    func testPreprocess1() {
        ...
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test1.html")
    ...
    func testPreprocess2() {
        ...
        let resultA = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test2.html")
        ...
        let resultB = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test2b.html")
    ...
    func testPreprocess3() {
        ...
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test3.html")
    ...
    func testPreprocess4() {
        ...
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test4.html")
    ...
    func testPreprocess5() {
        ...
        let filepath = "/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test5.html"
    ...
    func testNotAValidPreprocessingToken() {
        ...
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test2.js")
                
        XCTAssertEqual(result, "\n\nvar x = 5\n`width:${x}em;height:${x}em;`\n")
    }
    
    func testPreprocessUnknownDirective() {
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/test1.css")
        XCTAssertEqual(result, "\n#title {\n    border-image-slice: 22 fill;\n}\n")
    }
    
    func testPreprocessIncludeFromSourcePath() {
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/include1.css")
        XCTAssertEqual(result, "\n#title {\n    border-image-slice: 22 fill;\n}\n\n#title {\n    border-image-slice: 22 fill;\n}\n")
    }
    
    func testPreprocessImageFile() {
        let result = PamphletFramework().preprocess("/Users/rjbowli/Development/chimerasw/Pamphlet/meta/include_image.js")
